...
const IG = props => {
  ...
  const token = {
    ...
    'Egypt':'IGQVJVZAkE5OW5KMUxrZAXBaTEM3bXBHOW44dkNNU1RVNWNvMndMbjNDZADlaWE9pNjJibXNiMFFoUW1qXzFNZATEtQ3hBOUFPNEUwa0FoREtZAbXhnXzd5a1NLVjRYaTRGekRFVUpweklSTTVSZAkdpWDg5QwZDZD',
  }

...
const Header2 = (props) => {
 ...
 // let [country, setCountry] = useState("Singapore")
  ...
  return (
    <header className={`headerWrapper sticky top-0 z-50 w-full  px-2 md:px-10 bg-black hidden md:block`}>
      <nav className="nav relative flex justify-end items-center w-full py-4">
        ...
        <div className="right flex w-full justify-end">
          <Scrollspy className="flex items-center w-2/3 justify-around" items={ ['menu', 'behindTheBeans', 'howToOrder', 'news'] } currentClassName="border-b-4 border-white a_opacity-100">
            ...
            <li>
              <Link to="#behindTheBeans" href="behindTheBeans" className={`${link} `}>
                <span className="my-auto">BEHIND THE BEANS</span>
              </Link>
            </li>
            <li>
              <Link to="#howToOrder" href="howToOrder" className={`${link} `}>
                <span className="my-auto">HOW TO ORDER </span>
              </Link>
            </li>
            <li>
              <Link to="#news" href="news" className={`${link} `}>
